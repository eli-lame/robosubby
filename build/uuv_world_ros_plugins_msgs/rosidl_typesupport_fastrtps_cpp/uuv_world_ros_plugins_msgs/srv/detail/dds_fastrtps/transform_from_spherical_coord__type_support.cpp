...
#include "uuv_world_ros_plugins_msgs/srv/detail/transform_from_spherical_coord__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uuv_world_ros_plugins_msgs::srv::TransformFromSphericalCoord_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uuv_world_ros_plugins_msgs::srv::TransformFromSphericalCoord_Request & ros_message)
{
  // Member: latitude_deg
  cdr >> ros_message.latitude_deg;
...
{
  auto typed_message =
    static_cast<const uuv_world_ros_plugins_msgs::srv::TransformFromSphericalCoord_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uuv_world_ros_plugins_msgs::srv::TransformFromSphericalCoord_Request *>(
    untyped_ros_message);
...
{
  return max_serialized_size_TransformFromSphericalCoord_Request(full_bounded, 0);
}
...
{
  return &uuv_world_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_TransformFromSphericalCoord_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_world_ros_plugins_msgs, srv, TransformFromSphericalCoord_Request)() {
  return &uuv_world_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_TransformFromSphericalCoord_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_uuv_world_ros_plugins_msgs
cdr_serialize(
  const uuv_world_ros_plugins_msgs::srv::TransformFromSphericalCoord_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: output
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uuv_world_ros_plugins_msgs::srv::TransformFromSphericalCoord_Response & ros_message)
{
  // Member: output
...
{
  auto typed_message =
    static_cast<const uuv_world_ros_plugins_msgs::srv::TransformFromSphericalCoord_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<uuv_world_ros_plugins_msgs::srv::TransformFromSphericalCoord_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return max_serialized_size_TransformFromSphericalCoord_Response(full_bounded, 0);
}
...
{
  return &uuv_world_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_TransformFromSphericalCoord_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_world_ros_plugins_msgs, srv, TransformFromSphericalCoord_Response)() {
  return &uuv_world_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_TransformFromSphericalCoord_Response__handle;
}
...
{
  return &uuv_world_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_TransformFromSphericalCoord__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_world_ros_plugins_msgs, srv, TransformFromSphericalCoord)() {
  return &uuv_world_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_TransformFromSphericalCoord__handle;
}
