...
#include "uuv_control_msgs/srv/detail/add_waypoint__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const uuv_control_msgs::srv::AddWaypoint_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uuv_control_msgs::srv::AddWaypoint_Request *>(
    untyped_ros_message);
...
static size_t _AddWaypoint_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_AddWaypoint_Request(full_bounded, 0);
}
...
{
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_AddWaypoint_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const uuv_control_msgs::srv::AddWaypoint_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<uuv_control_msgs::srv::AddWaypoint_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _AddWaypoint_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_AddWaypoint_Response(full_bounded, 0);
}
...
{
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_AddWaypoint_Response__handle;
}
...
{
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_AddWaypoint__handle;
}
