...
#include "uuv_sensor_ros_plugins_msgs/msg/detail/dvl__rosidl_typesupport_fastrtps_c.h"
...
#include "uuv_sensor_ros_plugins_msgs/msg/detail/dvl_beam__functions.h"  // beams
...
using _DVL__ros_msg_type = uuv_sensor_ros_plugins_msgs__msg__DVL;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: beams
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, uuv_sensor_ros_plugins_msgs, msg, DVLBeam
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: beams
  {
    ...
    if (ros_message->beams.data) {
      uuv_sensor_ros_plugins_msgs__msg__DVLBeam__Sequence__fini(&ros_message->beams);
    }
...
size_t get_serialized_size_uuv_sensor_ros_plugins_msgs__msg__DVL(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _DVL__ros_msg_type * ros_message = static_cast<const _DVL__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name beams
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_uuv_sensor_ros_plugins_msgs__msg__DVLBeam(
...
static uint32_t _DVL__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_uuv_sensor_ros_plugins_msgs__msg__DVL(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_uuv_sensor_ros_plugins_msgs
size_t max_serialized_size_uuv_sensor_ros_plugins_msgs__msg__DVL(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
  ...
  // member: beams
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_uuv_sensor_ros_plugins_msgs__msg__DVLBeam(
        full_bounded, current_alignment);
    }
  }
...
{
  return max_serialized_size_uuv_sensor_ros_plugins_msgs__msg__DVL(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, uuv_sensor_ros_plugins_msgs, msg, DVL)() {
