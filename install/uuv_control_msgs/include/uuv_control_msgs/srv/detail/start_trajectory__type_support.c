...
#include <stddef.h>
#include "uuv_control_msgs/srv/detail/start_trajectory__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  uuv_control_msgs__srv__StartTrajectory_Request__init(message_memory);
}
...
{
  uuv_control_msgs__srv__StartTrajectory_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember StartTrajectory_Request__rosidl_typesupport_introspection_c__StartTrajectory_Request_message_member_array[1] = {
  {
    ...
    offsetof(uuv_control_msgs__srv__StartTrajectory_Request, structure_needs_at_least_one_member),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers StartTrajectory_Request__rosidl_typesupport_introspection_c__StartTrajectory_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(uuv_control_msgs__srv__StartTrajectory_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uuv_control_msgs, srv, StartTrajectory_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  uuv_control_msgs__srv__StartTrajectory_Response__init(message_memory);
}
...
{
  uuv_control_msgs__srv__StartTrajectory_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember StartTrajectory_Response__rosidl_typesupport_introspection_c__StartTrajectory_Response_message_member_array[1] = {
  {
    "success",  // name
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uuv_control_msgs__srv__StartTrajectory_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers StartTrajectory_Response__rosidl_typesupport_introspection_c__StartTrajectory_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(uuv_control_msgs__srv__StartTrajectory_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_uuv_control_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uuv_control_msgs, srv, StartTrajectory_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers uuv_control_msgs__srv__detail__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_service_members = {
  "uuv_control_msgs__srv",  // service namespace
  "StartTrajectory",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // uuv_control_msgs__srv__detail__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_Request_message_type_support_handle,
  NULL  // response message
  // uuv_control_msgs__srv__detail__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_Response_message_type_support_handle
};

static rosidl_service_type_support_t uuv_control_msgs__srv__detail__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_service_type_support_handle = {
  0,
  &uuv_control_msgs__srv__detail__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uuv_control_msgs, srv, StartTrajectory)() {
  if (!uuv_control_msgs__srv__detail__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_service_type_support_handle.typesupport_identifier) {
    uuv_control_msgs__srv__detail__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)uuv_control_msgs__srv__detail__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uuv_control_msgs, srv, StartTrajectory_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uuv_control_msgs, srv, StartTrajectory_Response)()->data;
  }

  return &uuv_control_msgs__srv__detail__start_trajectory__rosidl_typesupport_introspection_c__StartTrajectory_service_type_support_handle;
}
