...
class Metaclass_AddWaypoint(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'uuv_control_msgs.srv.AddWaypoint')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from uuv_control_msgs.srv import _add_waypoint
...
class AddWaypoint(metaclass=Metaclass_AddWaypoint):
    from uuv_control_msgs.srv._add_waypoint import AddWaypoint_Request as Request
    from uuv_control_msgs.srv._add_waypoint import AddWaypoint_Response as Response
