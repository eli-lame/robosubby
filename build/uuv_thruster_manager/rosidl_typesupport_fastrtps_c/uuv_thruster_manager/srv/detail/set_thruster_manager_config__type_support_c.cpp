...
static size_t _SetThrusterManagerConfig_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_uuv_thruster_manager__srv__SetThrusterManagerConfig_Request(
    full_bounded, 0);
}
...
static size_t _SetThrusterManagerConfig_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_uuv_thruster_manager__srv__SetThrusterManagerConfig_Response(
    full_bounded, 0);
}
