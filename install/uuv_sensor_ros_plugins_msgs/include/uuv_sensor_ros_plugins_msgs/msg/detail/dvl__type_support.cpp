...
{
  new (message_memory) uuv_sensor_ros_plugins_msgs::msg::DVL(_init);
}

void DVL_fini_function(void * message_memory)
{
  auto typed_message = static_cast<uuv_sensor_ros_plugins_msgs::msg::DVL *>(message_memory);
  typed_message->~DVL();
}
...
{
  const auto * member = reinterpret_cast<const std::vector<uuv_sensor_ros_plugins_msgs::msg::DVLBeam> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<uuv_sensor_ros_plugins_msgs::msg::DVLBeam> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<uuv_sensor_ros_plugins_msgs::msg::DVLBeam> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DVL_message_member_array[5] = {
  {
    ...
    offsetof(uuv_sensor_ros_plugins_msgs::msg::DVL, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uuv_sensor_ros_plugins_msgs::msg::DVL, velocity),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    9,  // array size
    false,  // is upper bound
    offsetof(uuv_sensor_ros_plugins_msgs::msg::DVL, velocity_covariance),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(uuv_sensor_ros_plugins_msgs::msg::DVL, altitude),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<uuv_sensor_ros_plugins_msgs::msg::DVLBeam>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(uuv_sensor_ros_plugins_msgs::msg::DVL, beams),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers DVL_message_members = {
  ...
  "DVL",  // message name
  5,  // number of fields
  sizeof(uuv_sensor_ros_plugins_msgs::msg::DVL),
...
{
  return &::uuv_sensor_ros_plugins_msgs::msg::rosidl_typesupport_introspection_cpp::DVL_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, uuv_sensor_ros_plugins_msgs, msg, DVL)() {
  return &::uuv_sensor_ros_plugins_msgs::msg::rosidl_typesupport_introspection_cpp::DVL_message_type_support_handle;
}
