...
#include "uuv_control_msgs/msg/detail/waypoint_set__rosidl_typesupport_fastrtps_c.h"
...
using _WaypointSet__ros_msg_type = uuv_control_msgs__msg__WaypointSet;

static bool _WaypointSet__cdr_serialize(
  const void * untyped_ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _WaypointSet__ros_msg_type * ros_message = static_cast<const _WaypointSet__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
...
static bool _WaypointSet__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _WaypointSet__ros_msg_type * ros_message = static_cast<_WaypointSet__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_uuv_control_msgs__msg__WaypointSet(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _WaypointSet__ros_msg_type * ros_message = static_cast<const _WaypointSet__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _WaypointSet__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_uuv_control_msgs__msg__WaypointSet(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_uuv_control_msgs
size_t max_serialized_size_uuv_control_msgs__msg__WaypointSet(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
static size_t _WaypointSet__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_uuv_control_msgs__msg__WaypointSet(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_WaypointSet = {
  "uuv_control_msgs::msg",
  "WaypointSet",
  _WaypointSet__cdr_serialize,
  _WaypointSet__cdr_deserialize,
  _WaypointSet__get_serialized_size,
  _WaypointSet__max_serialized_size
};

static rosidl_message_type_support_t _WaypointSet__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_WaypointSet,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, uuv_control_msgs, msg, WaypointSet)() {
  return &_WaypointSet__type_support;
}
