...
void InitRectTrajectory_Request__rosidl_typesupport_introspection_c__InitRectTrajectory_Request_init_function(
...
void InitRectTrajectory_Request__rosidl_typesupport_introspection_c__InitRectTrajectory_Request_fini_function(void * message_memory)
{
  uuv_control_msgs__srv__InitRectTrajectory_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember InitRectTrajectory_Request__rosidl_typesupport_introspection_c__InitRectTrajectory_Request_message_member_array[8] = {
  {
    "start_time",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers InitRectTrajectory_Request__rosidl_typesupport_introspection_c__InitRectTrajectory_Request_message_members = {
  ...
  InitRectTrajectory_Request__rosidl_typesupport_introspection_c__InitRectTrajectory_Request_message_member_array,  // message members
  InitRectTrajectory_Request__rosidl_typesupport_introspection_c__InitRectTrajectory_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  InitRectTrajectory_Request__rosidl_typesupport_introspection_c__InitRectTrajectory_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t InitRectTrajectory_Request__rosidl_typesupport_introspection_c__InitRectTrajectory_Request_message_type_support_handle = {
  0,
  &InitRectTrajectory_Request__rosidl_typesupport_introspection_c__InitRectTrajectory_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uuv_control_msgs, srv, InitRectTrajectory_Request)() {
  InitRectTrajectory_Request__rosidl_typesupport_introspection_c__InitRectTrajectory_Request_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, builtin_interfaces, msg, Time)();
  InitRectTrajectory_Request__rosidl_typesupport_introspection_c__InitRectTrajectory_Request_message_member_array[2].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, geometry_msgs, msg, Point)();
  if (!InitRectTrajectory_Request__rosidl_typesupport_introspection_c__InitRectTrajectory_Request_message_type_support_handle.typesupport_identifier) {
    InitRectTrajectory_Request__rosidl_typesupport_introspection_c__InitRectTrajectory_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &InitRectTrajectory_Request__rosidl_typesupport_introspection_c__InitRectTrajectory_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void InitRectTrajectory_Response__rosidl_typesupport_introspection_c__InitRectTrajectory_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void InitRectTrajectory_Response__rosidl_typesupport_introspection_c__InitRectTrajectory_Response_fini_function(void * message_memory)
{
  uuv_control_msgs__srv__InitRectTrajectory_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember InitRectTrajectory_Response__rosidl_typesupport_introspection_c__InitRectTrajectory_Response_message_member_array[1] = {
  {
    "success",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_BOOLEAN,  // type
    0,  // upper bound of string
...
static const rosidl_typesupport_introspection_c__MessageMembers InitRectTrajectory_Response__rosidl_typesupport_introspection_c__InitRectTrajectory_Response_message_members = {
  "uuv_control_msgs__srv",  // message namespace
  "InitRectTrajectory_Response",  // message name
  1,  // number of fields
  sizeof(uuv_control_msgs__srv__InitRectTrajectory_Response),
  InitRectTrajectory_Response__rosidl_typesupport_introspection_c__InitRectTrajectory_Response_message_member_array,  // message members
  InitRectTrajectory_Response__rosidl_typesupport_introspection_c__InitRectTrajectory_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  InitRectTrajectory_Response__rosidl_typesupport_introspection_c__InitRectTrajectory_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t InitRectTrajectory_Response__rosidl_typesupport_introspection_c__InitRectTrajectory_Response_message_type_support_handle = {
  0,
  &InitRectTrajectory_Response__rosidl_typesupport_introspection_c__InitRectTrajectory_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uuv_control_msgs, srv, InitRectTrajectory_Response)() {
  if (!InitRectTrajectory_Response__rosidl_typesupport_introspection_c__InitRectTrajectory_Response_message_type_support_handle.typesupport_identifier) {
    InitRectTrajectory_Response__rosidl_typesupport_introspection_c__InitRectTrajectory_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &InitRectTrajectory_Response__rosidl_typesupport_introspection_c__InitRectTrajectory_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
