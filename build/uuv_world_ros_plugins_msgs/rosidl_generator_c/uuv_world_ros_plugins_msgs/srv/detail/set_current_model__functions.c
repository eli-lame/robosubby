  ...
  uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request * data =
      (uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response * data =
      (uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          uuv_world_ros_plugins_msgs__srv__SetCurrentModel_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
