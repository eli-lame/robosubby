...
#include "uuv_sensor_ros_plugins_msgs/msg/detail/salinity__rosidl_typesupport_fastrtps_c.h"
...
using _Salinity__ros_msg_type = uuv_sensor_ros_plugins_msgs__msg__Salinity;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Salinity__ros_msg_type * ros_message = static_cast<const _Salinity__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Salinity__ros_msg_type * ros_message = static_cast<_Salinity__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_uuv_sensor_ros_plugins_msgs__msg__Salinity(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Salinity__ros_msg_type * ros_message = static_cast<const _Salinity__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Salinity__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_uuv_sensor_ros_plugins_msgs__msg__Salinity(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_uuv_sensor_ros_plugins_msgs
size_t max_serialized_size_uuv_sensor_ros_plugins_msgs__msg__Salinity(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_uuv_sensor_ros_plugins_msgs__msg__Salinity(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_Salinity = {
...
static rosidl_message_type_support_t _Salinity__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Salinity,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, uuv_sensor_ros_plugins_msgs, msg, Salinity)() {
  return &_Salinity__type_support;
}
