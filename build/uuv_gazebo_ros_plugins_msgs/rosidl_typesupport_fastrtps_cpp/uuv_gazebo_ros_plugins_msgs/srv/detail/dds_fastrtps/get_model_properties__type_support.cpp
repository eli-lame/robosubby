...
#include "uuv_gazebo_ros_plugins_msgs/srv/detail/get_model_properties__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uuv_gazebo_ros_plugins_msgs::srv::GetModelProperties_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uuv_gazebo_ros_plugins_msgs::srv::GetModelProperties_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const uuv_gazebo_ros_plugins_msgs::srv::GetModelProperties_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uuv_gazebo_ros_plugins_msgs::srv::GetModelProperties_Request *>(
    untyped_ros_message);
...
{
  return max_serialized_size_GetModelProperties_Request(full_bounded, 0);
}
...
{
  return &uuv_gazebo_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_GetModelProperties_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_gazebo_ros_plugins_msgs, srv, GetModelProperties_Request)() {
  return &uuv_gazebo_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_GetModelProperties_Request__handle;
}
...
{
bool cdr_serialize(
  const uuv_gazebo_ros_plugins_msgs::msg::UnderwaterObjectModel &,
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_uuv_gazebo_ros_plugins_msgs
cdr_serialize(
  const uuv_gazebo_ros_plugins_msgs::srv::GetModelProperties_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: link_names
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uuv_gazebo_ros_plugins_msgs::srv::GetModelProperties_Response & ros_message)
{
  // Member: link_names
  {
    cdr >> ros_message.link_names;
  ...
  size_t current_alignment)
{
  ...
  // Member: models
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        uuv_gazebo_ros_plugins_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_UnderwaterObjectModel(
...
{
  auto typed_message =
    static_cast<const uuv_gazebo_ros_plugins_msgs::srv::GetModelProperties_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<uuv_gazebo_ros_plugins_msgs::srv::GetModelProperties_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return max_serialized_size_GetModelProperties_Response(full_bounded, 0);
}
...
{
  return &uuv_gazebo_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_GetModelProperties_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_gazebo_ros_plugins_msgs, srv, GetModelProperties_Response)() {
  return &uuv_gazebo_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_GetModelProperties_Response__handle;
}
...
{
  return &uuv_gazebo_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_GetModelProperties__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_gazebo_ros_plugins_msgs, srv, GetModelProperties)() {
  return &uuv_gazebo_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_GetModelProperties__handle;
}
