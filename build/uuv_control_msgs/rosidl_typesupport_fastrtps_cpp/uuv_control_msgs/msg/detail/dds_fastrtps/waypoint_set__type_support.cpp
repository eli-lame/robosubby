...
#include "uuv_control_msgs/msg/detail/waypoint_set__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const uuv_control_msgs::msg::WaypointSet *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uuv_control_msgs::msg::WaypointSet *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _WaypointSet__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const uuv_control_msgs::msg::WaypointSet *>(
...
{
  return max_serialized_size_WaypointSet(full_bounded, 0);
}

static message_type_support_callbacks_t _WaypointSet__callbacks = {
...
static rosidl_message_type_support_t _WaypointSet__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_WaypointSet__callbacks,
...
{
  return &uuv_control_msgs::msg::typesupport_fastrtps_cpp::_WaypointSet__handle;
}
