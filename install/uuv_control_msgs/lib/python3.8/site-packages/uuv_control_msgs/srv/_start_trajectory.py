...
class Metaclass_StartTrajectory(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'uuv_control_msgs.srv.StartTrajectory')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from uuv_control_msgs.srv import _start_trajectory
...
class StartTrajectory(metaclass=Metaclass_StartTrajectory):
    from uuv_control_msgs.srv._start_trajectory import StartTrajectory_Request as Request
    from uuv_control_msgs.srv._start_trajectory import StartTrajectory_Response as Response
