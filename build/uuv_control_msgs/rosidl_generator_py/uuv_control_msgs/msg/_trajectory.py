    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'uuv_control_msgs.msg.Trajectory')
            logger.debug(
...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    _fields_and_field_types = {
        ...
        'points': 'sequence<uuv_control_msgs/TrajectoryPoint>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['uuv_control_msgs', 'msg'], 'TrajectoryPoint')),  # noqa: E501
    )
