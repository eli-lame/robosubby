...
{
  return max_serialized_size_uuv_gazebo_ros_plugins_msgs__srv__GetThrusterEfficiency_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_uuv_gazebo_ros_plugins_msgs__srv__GetThrusterEfficiency_Response(
    full_bounded, 0);
}
