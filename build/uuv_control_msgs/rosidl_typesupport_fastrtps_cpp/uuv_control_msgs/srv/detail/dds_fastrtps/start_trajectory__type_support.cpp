...
#include "uuv_control_msgs/srv/detail/start_trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uuv_control_msgs::srv::StartTrajectory_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uuv_control_msgs::srv::StartTrajectory_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const uuv_control_msgs::srv::StartTrajectory_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uuv_control_msgs::srv::StartTrajectory_Request *>(
    untyped_ros_message);
...
{
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_StartTrajectory_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_control_msgs, srv, StartTrajectory_Request)() {
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_StartTrajectory_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_uuv_control_msgs
cdr_serialize(
  const uuv_control_msgs::srv::StartTrajectory_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uuv_control_msgs::srv::StartTrajectory_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const uuv_control_msgs::srv::StartTrajectory_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<uuv_control_msgs::srv::StartTrajectory_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_StartTrajectory_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_control_msgs, srv, StartTrajectory_Response)() {
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_StartTrajectory_Response__handle;
}
...
{
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_StartTrajectory__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_control_msgs, srv, StartTrajectory)() {
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_StartTrajectory__handle;
}
