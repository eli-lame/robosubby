...
void SetThrusterManagerConfig_Request__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Request_init_function(
...
void SetThrusterManagerConfig_Request__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Request_fini_function(void * message_memory)
{
  uuv_thruster_manager__srv__SetThrusterManagerConfig_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetThrusterManagerConfig_Request__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Request_message_member_array[6] = {
  {
    "base_link",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SetThrusterManagerConfig_Request__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Request_message_members = {
  ...
  SetThrusterManagerConfig_Request__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Request_message_member_array,  // message members
  SetThrusterManagerConfig_Request__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  SetThrusterManagerConfig_Request__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SetThrusterManagerConfig_Request__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Request_message_type_support_handle = {
  0,
  &SetThrusterManagerConfig_Request__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uuv_thruster_manager, srv, SetThrusterManagerConfig_Request)() {
  if (!SetThrusterManagerConfig_Request__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Request_message_type_support_handle.typesupport_identifier) {
    SetThrusterManagerConfig_Request__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SetThrusterManagerConfig_Request__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void SetThrusterManagerConfig_Response__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void SetThrusterManagerConfig_Response__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Response_fini_function(void * message_memory)
{
  uuv_thruster_manager__srv__SetThrusterManagerConfig_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember SetThrusterManagerConfig_Response__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Response_message_member_array[1] = {
  {
    "success",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers SetThrusterManagerConfig_Response__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Response_message_members = {
  "uuv_thruster_manager__srv",  // message namespace
  "SetThrusterManagerConfig_Response",  // message name
  1,  // number of fields
  sizeof(uuv_thruster_manager__srv__SetThrusterManagerConfig_Response),
  SetThrusterManagerConfig_Response__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Response_message_member_array,  // message members
  SetThrusterManagerConfig_Response__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  SetThrusterManagerConfig_Response__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t SetThrusterManagerConfig_Response__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Response_message_type_support_handle = {
  0,
  &SetThrusterManagerConfig_Response__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uuv_thruster_manager, srv, SetThrusterManagerConfig_Response)() {
  if (!SetThrusterManagerConfig_Response__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Response_message_type_support_handle.typesupport_identifier) {
    SetThrusterManagerConfig_Response__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &SetThrusterManagerConfig_Response__rosidl_typesupport_introspection_c__SetThrusterManagerConfig_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
