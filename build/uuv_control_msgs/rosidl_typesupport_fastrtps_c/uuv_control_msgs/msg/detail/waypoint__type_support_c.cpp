...
#include "uuv_control_msgs/msg/detail/waypoint__rosidl_typesupport_fastrtps_c.h"
...
using _Waypoint__ros_msg_type = uuv_control_msgs__msg__Waypoint;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: use_fixed_heading
  {
    cdr << (ros_message->use_fixed_heading ? true : false);
  }

  // Field name: radius_of_acceptance
  {
...
static uint32_t _Waypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_uuv_control_msgs__msg__Waypoint(
...
{
  return max_serialized_size_uuv_control_msgs__msg__Waypoint(
    full_bounded, 0);
}
