...
#include "uuv_control_msgs/srv/detail/get_waypoints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uuv_control_msgs::srv::GetWaypoints_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uuv_control_msgs::srv::GetWaypoints_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const uuv_control_msgs::srv::GetWaypoints_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uuv_control_msgs::srv::GetWaypoints_Request *>(
    untyped_ros_message);
...
{
  return max_serialized_size_GetWaypoints_Request(full_bounded, 0);
}
...
{
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_GetWaypoints_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_control_msgs, srv, GetWaypoints_Request)() {
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_GetWaypoints_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_uuv_control_msgs
cdr_serialize(
  const uuv_control_msgs::srv::GetWaypoints_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: waypoints
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uuv_control_msgs::srv::GetWaypoints_Response & ros_message)
{
  // Member: waypoints
  {
    uint32_t cdrSize;
...
{
  auto typed_message =
    static_cast<const uuv_control_msgs::srv::GetWaypoints_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<uuv_control_msgs::srv::GetWaypoints_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return max_serialized_size_GetWaypoints_Response(full_bounded, 0);
}
...
{
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_GetWaypoints_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_control_msgs, srv, GetWaypoints_Response)() {
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_GetWaypoints_Response__handle;
}
...
{
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_GetWaypoints__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_control_msgs, srv, GetWaypoints)() {
  return &uuv_control_msgs::srv::typesupport_fastrtps_cpp::_GetWaypoints__handle;
}
