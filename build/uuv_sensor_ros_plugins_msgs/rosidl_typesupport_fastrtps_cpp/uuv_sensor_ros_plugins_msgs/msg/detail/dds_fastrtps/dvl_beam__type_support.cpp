...
#include "uuv_sensor_ros_plugins_msgs/msg/detail/dvl_beam__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uuv_sensor_ros_plugins_msgs::msg::DVLBeam & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uuv_sensor_ros_plugins_msgs::msg::DVLBeam & ros_message)
{
  // Member: range
  cdr >> ros_message.range;
...
{
  auto typed_message =
    static_cast<const uuv_sensor_ros_plugins_msgs::msg::DVLBeam *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uuv_sensor_ros_plugins_msgs::msg::DVLBeam *>(
    untyped_ros_message);
...
{
  return max_serialized_size_DVLBeam(full_bounded, 0);
}
...
{
  return &uuv_sensor_ros_plugins_msgs::msg::typesupport_fastrtps_cpp::_DVLBeam__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_sensor_ros_plugins_msgs, msg, DVLBeam)() {
  return &uuv_sensor_ros_plugins_msgs::msg::typesupport_fastrtps_cpp::_DVLBeam__handle;
}
