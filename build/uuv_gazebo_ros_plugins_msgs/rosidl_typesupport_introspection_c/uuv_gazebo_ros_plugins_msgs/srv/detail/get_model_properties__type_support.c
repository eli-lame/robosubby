...
void GetModelProperties_Request__rosidl_typesupport_introspection_c__GetModelProperties_Request_init_function(
...
void GetModelProperties_Request__rosidl_typesupport_introspection_c__GetModelProperties_Request_fini_function(void * message_memory)
{
...
static const rosidl_typesupport_introspection_c__MessageMembers GetModelProperties_Request__rosidl_typesupport_introspection_c__GetModelProperties_Request_message_members = {
  ...
  GetModelProperties_Request__rosidl_typesupport_introspection_c__GetModelProperties_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetModelProperties_Request__rosidl_typesupport_introspection_c__GetModelProperties_Request_fini_function  // function to terminate message instance (will not free memory)
};
...
void GetModelProperties_Response__rosidl_typesupport_introspection_c__GetModelProperties_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetModelProperties_Response__rosidl_typesupport_introspection_c__GetModelProperties_Response_fini_function(void * message_memory)
{
  uuv_gazebo_ros_plugins_msgs__srv__GetModelProperties_Response__fini(message_memory);
}

size_t GetModelProperties_Response__rosidl_typesupport_introspection_c__size_function__UnderwaterObjectModel__models(
...
const void * GetModelProperties_Response__rosidl_typesupport_introspection_c__get_const_function__UnderwaterObjectModel__models(
...
void * GetModelProperties_Response__rosidl_typesupport_introspection_c__get_function__UnderwaterObjectModel__models(
...
bool GetModelProperties_Response__rosidl_typesupport_introspection_c__resize_function__UnderwaterObjectModel__models(
...
static rosidl_typesupport_introspection_c__MessageMember GetModelProperties_Response__rosidl_typesupport_introspection_c__GetModelProperties_Response_message_member_array[2] = {
  {
    "link_names",  // name
  ...
  },
  {
    ...
    NULL,  // default value
    GetModelProperties_Response__rosidl_typesupport_introspection_c__size_function__UnderwaterObjectModel__models,  // size() function pointer
    GetModelProperties_Response__rosidl_typesupport_introspection_c__get_const_function__UnderwaterObjectModel__models,  // get_const(index) function pointer
    GetModelProperties_Response__rosidl_typesupport_introspection_c__get_function__UnderwaterObjectModel__models,  // get(index) function pointer
    GetModelProperties_Response__rosidl_typesupport_introspection_c__resize_function__UnderwaterObjectModel__models  // resize(index) function pointer
  }
};
...
static const rosidl_typesupport_introspection_c__MessageMembers GetModelProperties_Response__rosidl_typesupport_introspection_c__GetModelProperties_Response_message_members = {
  ...
  GetModelProperties_Response__rosidl_typesupport_introspection_c__GetModelProperties_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetModelProperties_Response__rosidl_typesupport_introspection_c__GetModelProperties_Response_fini_function  // function to terminate message instance (will not free memory)
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uuv_gazebo_ros_plugins_msgs, srv, GetModelProperties_Response)() {
  GetModelProperties_Response__rosidl_typesupport_introspection_c__GetModelProperties_Response_message_member_array[1].members_ =
