...
{
  return max_serialized_size_uuv_control_msgs__srv__InitHelicalTrajectory_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_uuv_control_msgs__srv__InitHelicalTrajectory_Response(
    full_bounded, 0);
}
