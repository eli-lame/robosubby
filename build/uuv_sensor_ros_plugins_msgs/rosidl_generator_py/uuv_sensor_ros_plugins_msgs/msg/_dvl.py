    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'uuv_sensor_ros_plugins_msgs.msg.DVL')
            logger.debug(
            ...
            from uuv_sensor_ros_plugins_msgs.msg import DVLBeam
...
class DVL(metaclass=Metaclass_DVL):
    ...
    _fields_and_field_types = {
        ...
        'altitude': 'double',
        'beams': 'sequence<uuv_sensor_ros_plugins_msgs/DVLBeam>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['uuv_sensor_ros_plugins_msgs', 'msg'], 'DVLBeam')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'velocity_covariance' field must be a set or sequence with length 9 and each value of type 'float'"
