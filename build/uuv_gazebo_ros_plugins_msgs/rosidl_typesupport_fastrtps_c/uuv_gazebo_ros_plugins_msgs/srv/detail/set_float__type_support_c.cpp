...
{
  return max_serialized_size_uuv_gazebo_ros_plugins_msgs__srv__SetFloat_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_uuv_gazebo_ros_plugins_msgs__srv__SetFloat_Response(
    full_bounded, 0);
}
