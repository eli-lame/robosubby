...
class Metaclass_GoTo_Request(type):
    ...
    def LIPB(self):
        ...
        return Metaclass_GoTo_Request.__constants['LIPB']

    @property
    def CUBIC(self):
        """Message constant 'CUBIC'."""
        return Metaclass_GoTo_Request.__constants['CUBIC']

    @property
    def DUBINS(self):
        """Message constant 'DUBINS'."""
        return Metaclass_GoTo_Request.__constants['DUBINS']

    @property
    def LINEAR(self):
        """Message constant 'LINEAR'."""
        return Metaclass_GoTo_Request.__constants['LINEAR']
...
class GoTo_Request(metaclass=Metaclass_GoTo_Request):
    ...
    _fields_and_field_types = {
        'waypoint': 'uuv_control_msgs/Waypoint',
        'max_forward_speed': 'double',
        'interpolator': 'string',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['uuv_control_msgs', 'msg'], 'Waypoint'),  # noqa: E501
...
class Metaclass_GoTo(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from uuv_control_msgs.srv import _go_to
...
class GoTo(metaclass=Metaclass_GoTo):
    from uuv_control_msgs.srv._go_to import GoTo_Request as Request
    from uuv_control_msgs.srv._go_to import GoTo_Response as Response
