...
class Metaclass_GetWaypoints(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'uuv_control_msgs.srv.GetWaypoints')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from uuv_control_msgs.srv import _get_waypoints
...
class GetWaypoints(metaclass=Metaclass_GetWaypoints):
    from uuv_control_msgs.srv._get_waypoints import GetWaypoints_Request as Request
    from uuv_control_msgs.srv._get_waypoints import GetWaypoints_Response as Response
