...
static const _SetFloat_Request_type_support_symbol_names_t _SetFloat_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, uuv_gazebo_ros_plugins_msgs, srv, SetFloat_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uuv_gazebo_ros_plugins_msgs, srv, SetFloat_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, uuv_gazebo_ros_plugins_msgs, srv, SetFloat_Request)() {
  return &::uuv_gazebo_ros_plugins_msgs::srv::rosidl_typesupport_c::SetFloat_Request_message_type_support_handle;
}
...
static const _SetFloat_Response_type_support_symbol_names_t _SetFloat_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, uuv_gazebo_ros_plugins_msgs, srv, SetFloat_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uuv_gazebo_ros_plugins_msgs, srv, SetFloat_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_uuv_gazebo_ros_plugins_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, uuv_gazebo_ros_plugins_msgs, srv, SetFloat_Response)() {
  return &::uuv_gazebo_ros_plugins_msgs::srv::rosidl_typesupport_c::SetFloat_Response_message_type_support_handle;
}
...
static const _SetFloat_type_support_symbol_names_t _SetFloat_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, uuv_gazebo_ros_plugins_msgs, srv, SetFloat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, uuv_gazebo_ros_plugins_msgs, srv, SetFloat)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, uuv_gazebo_ros_plugins_msgs, srv, SetFloat)() {
  return &::uuv_gazebo_ros_plugins_msgs::srv::rosidl_typesupport_c::SetFloat_service_type_support_handle;
}
