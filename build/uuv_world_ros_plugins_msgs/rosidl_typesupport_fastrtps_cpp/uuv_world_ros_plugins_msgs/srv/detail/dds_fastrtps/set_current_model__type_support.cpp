...
#include "uuv_world_ros_plugins_msgs/srv/detail/set_current_model__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const uuv_world_ros_plugins_msgs::srv::SetCurrentModel_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uuv_world_ros_plugins_msgs::srv::SetCurrentModel_Request & ros_message)
{
  // Member: mean
  cdr >> ros_message.mean;
...
{
  auto typed_message =
    static_cast<const uuv_world_ros_plugins_msgs::srv::SetCurrentModel_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<uuv_world_ros_plugins_msgs::srv::SetCurrentModel_Request *>(
    untyped_ros_message);
...
static size_t _SetCurrentModel_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_SetCurrentModel_Request(full_bounded, 0);
}
...
{
  return &uuv_world_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_SetCurrentModel_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_world_ros_plugins_msgs, srv, SetCurrentModel_Request)() {
  return &uuv_world_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_SetCurrentModel_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_uuv_world_ros_plugins_msgs
cdr_serialize(
  const uuv_world_ros_plugins_msgs::srv::SetCurrentModel_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  uuv_world_ros_plugins_msgs::srv::SetCurrentModel_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
...
{
  auto typed_message =
    static_cast<const uuv_world_ros_plugins_msgs::srv::SetCurrentModel_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<uuv_world_ros_plugins_msgs::srv::SetCurrentModel_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
static size_t _SetCurrentModel_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_SetCurrentModel_Response(full_bounded, 0);
}
...
{
  return &uuv_world_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_SetCurrentModel_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_world_ros_plugins_msgs, srv, SetCurrentModel_Response)() {
  return &uuv_world_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_SetCurrentModel_Response__handle;
}
...
{
  return &uuv_world_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_SetCurrentModel__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, uuv_world_ros_plugins_msgs, srv, SetCurrentModel)() {
  return &uuv_world_ros_plugins_msgs::srv::typesupport_fastrtps_cpp::_SetCurrentModel__handle;
}
